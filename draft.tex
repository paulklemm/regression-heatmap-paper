...
%% TODO: Anmerkung Kai einarbeiten Ja, gefällt mir auch nicht so gut. Ich würde zunächst Keims Mantra vorstellen (mit itemize) dann dazu erklären was er damit meint und was es bedeutet. Diese Mantrapunkte nennst du M1-M4 (oder ein anderen Buchstaben). Und dann würde ich bei der Erklärung deines Tools immer wieder darauf verweisen, welcher Punkt nun erfüllt ist (..., which fulfills M2) 

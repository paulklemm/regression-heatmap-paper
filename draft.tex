...
%%
Therefore we provide template regression formulas, which are applied to all potential feature combinations.
%%
...
%%
We apply their requirements as guidelines, which incorporate \emph{flexible} and \emph{iterative analysis}. %, meaning that the system has to adapt to different requirements in different analysis steps.
%%
...
%%
In contrast, we aim for a fast large scale correlation analysis incorporating many features to derive insights.
%%
...
%%
\magenta{
As mentioned previously, the dimension reduction using the CFS algorithm potentially removes features important to the domain expert.
%%
To tackle this problem, the $z$ dimension of the visualization contains all features of the data set, allowing to assess their influence.
%%
...
\begin{figure}[htb]
 ...
 \caption{
 %%
 Breast fat data set loaded into our prototype.
 %%
...
%%
Therefore, complex systems, which require substantial training to work with are not suitable. %for the task of deriving overview visualizations.
%%
...
%%
Instructions and code on how to create a setup running the statistical back-end through a \href{http://www.ubuntu.com/}{\texttt{Ubuntu}} server using \href{https://www.opencpu.org/}{\texttt{OpenCPU}} are referenced in the repository.
%%

...
%%
This approach combines all \emph{independent features} with respect to a \emph{target feature} and provides a visualization that reveals insights into the data by highlighting relationships.
%%
...
%%
More discussions of cohort study data types and characteristics can be found in \cite{Klemm2014VIS, Toennies2015, Preim2014}.
%%
...
Our Regression Cube model is well-suited for different workflow analysis techniques, based on the Visual Analytics (VA) Mantra of Keim et al. \cite{Keim}:
...
%%
Auto-completing input variables also simplifies the approach and works as spell check of variable names.
%%

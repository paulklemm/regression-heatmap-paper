...
%%
The acquired features range from social and lifestyle factors to prior or current diseases and medications as well as medical parameters, such as blood pressure and also comprises non-radiating medical image data. e.g. magnetic resonance imaging (MRI).
%%
Medical image data may be quantified using user-defined landmarks, describing for example shape, volume or diameter of a structure.
%%
...
%%
Due to missing overview techniques, possibly interesting correlations lie within the data, but are not apparent.
%%
...
%%
We incorporate the regression analysis, which is familiar to the domain experts into overview visualizations, which can either be used for an hypothesis-free analysis or an analysis towards a specific disease or hypotheses.
%%
...
%%
To allow other users even outside the epidemiological application domain to access to our tool, we choose to do this using standard ASCII-based CSV files.
%%

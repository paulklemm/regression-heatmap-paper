...
%%
The analysis workflow follows the Visual Analytics Mantra of Keim et al \cite{Keim2008}:
...
%%
The design space of web-technologies is different to standard WIMP-Interfaces, right click menus, modal windows and menu bars are not established UI components in this context.
%%
Therefore we have to adapt our design respecting the affordances of web pages.
%%
Our prototype consists of different components:
\begin{itemize}
	%%
...
%%
Instead we apply SHA-256 hashing on the data set name using the data contents and disable directory listings on the web server to avoid data set downloads.
%% TODO: Implement this
...
The formula is checked for validity directly on input, indicating invalid formulas with a red halo around the text input, which turns to green for valid input.
%%

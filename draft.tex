...
%%
%The \emph{Regression Cube} can also be rendered using other descriptive features presented in \ref{sec:RegressionAnalysis} albeit our focus on $R^2$ values.
%%
%Domain experts with sound background on regression analysis can investigate the the cube with emphasis on specific aspects of the model.
%%
}
%%

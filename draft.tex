...
\item
 Paul Klemm, Kai Lawonn, Sylvia Gla{\ss}er, Uli Niemann, Bernhard Preim are with Otto-von-Guericke University Magdeburg, Germany. E-mail: \{klemm,lawonn,glasser,uli.niemann,preim\}@ovgu.de
\item
...
%%
Resting method and data exchange on web-based technologies offers many advantages.
%%
...
%%
During the analysis, one hotspot was always observable in the [\textbf{2.SI}] and [\textbf{3.ZF}] incorporating a high \emph{Interleukin-6} (\emph{IL-6}) correlation with liver fat values (Fig.~\ref{fig:Application} b).
%%
...
%%
A surprising finding were the strong correlations with \emph{kidney disorder} ($R^2$ values around $0.9$).
%%
...
%%
Investigations of the hepatic steatosis data set with both numerical and dichotomized liver fat values showed comparable results but slightly differed when it comes to details. %, but differences  %differing in detail.
%%
...
%%
Important events have to be highlighted in overview visualizations to steer the user's attention to interesting parts of the data.
%%

...
%%
%% TODO: Use this one? "Statistical resilience of random populations to random perturbations" - http://www.ncbi.nlm.nih.gov/pubmed/19256997 - wie eine Variable sich ÃƒÂ¤ndert, wenn man per Zufall die Populationen verÃƒÂ¤ndert, um zu schauen wie zuverlÃƒÂ¤ssig diese Statistik ist.
...
%%
%\com{GlaÃƒÂŸer, S., Niemann, U., Preim, B., and Spiliopoulou, M. (2013). Can we Distinguish Between Benign and Ma- lignant Breast Tumors in DCE-MRI}
...
%%
% nochmal checken wo $F$ eingeführt wird, hier oder im übernächsten Satz?
...
%%
% Ggf. wurde $F$ schon oben eingeführt, TODO
...
% warum war da ein "either", sollte der Satz etwas anderes ausdrücken?

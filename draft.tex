...
%%
%\com{http://link.springer.com/chapter/10.1007/978-3-642-39146-0_1#page-1}
\com{Turkey Metrics Paper}
\\\\
The work of Piringer et al. \cite{Piringer}, Angelelli et al. \cite{Angelelli} and Zhang et al. \cite{Zhang2014} is closest to ours regarding different aspects.
...
%%
They use \emph{pearssons R} to depict relationships towards target features and employ list views and scatter plots to visualize and rank them.
%%
...
\com{Problem: Only paper of co-authors in this section, will look one-sided!}
...
\com{Niemann, U.; Völzke, H.; Kühn, J.-P. Spiliopoulou, M. (2014), Learning and inspecting classification rules from longitudinal epidemiological data to identify predictive features on hepatic steatosis, Expert Systems with Applications 41 (11) , 5405-5415 .}
...
\com{Steenwijk: Integrated Visual Analysis for Heterogeneous Datasets in Cohort Studies}

\paragraph{Statistical Analysis}

\com{Regression Cube: A Technique for Multidimensional Visual Exploration and Interactive Pattern Finding}
\com{The Sparse Regression Cube: A Reliable Modeling Technique for Open Cyber-physical Systems}

\com{[Hierarchical Brushing of High-Dimensional Data Sets Using Quality Metrics]}

\com{Quality Metrics in High-Dimensional Data Visualization - An Overview and Systematization}
...
The method was very well received with our project partners, allowing them for the first time to retrieve a overview visualization of features, which does not highlights their pairwise correlations, but rather their explanatory power towards a target feature.
%%

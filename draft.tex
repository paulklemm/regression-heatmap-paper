...
%%
They analyzing subsets using a drilling-down approach by incorporating scatter plot matrices (\texttt{SPLOMÂ«S}) of quality metrics. %describing the features.
%%

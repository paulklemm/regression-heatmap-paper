...
We employ \emph{VDAR} for the evaluation of our system.
%%
...
%%
% nicht mit 3.ZF anfangen, das klingt niht gut.
The Zoom, Filter and Analyze Further Step (\textbf{3.ZF}) was realised by slicing through the cube using the mouse input to inspect the hot spots. Anaylzing the mosaic plot (\textbf{4.DD}) revealed high correlations for somatometric features, hepatic steatosis indicator-features as well as laboratory values, such as creatinine (used renal retention parameter) and uric acid (among others used as gout and diabetes risk factors) magnitudes.
%%
% da fehlte was im satz
Similar results were present for analyzing the \emph{female} groups.
%%
\emph{UN} could reproduce most results, some featuresexhibit lower correlations though, e.g., creatinine magnitudes.
%%
...
% das ist doch super. Hier noch ein Satz ob die Radiologen das gut finden. ist das nicht richtig geil? Mehr Infos!!!
%%
...
%%
% hier fehlt was
In literature, relations between liver cancer \cite{He2013} and also chronic liver diseases \cite{Streetz2003}.
%%
...
%%
The analysis aims to find relationships on the breast cancer data using features derived from the mammography analysis.
%%

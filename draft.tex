...
%%
We were able to derive new hypotheses about relations between breast density and breast lesions with breast cancer.
%%
%\com{Implications}.
%%
...
%%
%The $f$-$statistic$ determines how much improvement the independent variables will add to the model compared to being not considered at all.
...
%%
We incorporate their requirements, which consist of a \emph{flexible} and \emph{iterative analysis}. %, meaning that the system has to adapt to different requirements in different analysis steps.
%%
...
Epidemiologists will not adapt complex systems that require substantial training and time. %to work with are not suitable. %for the task of deriving overview visualizations.
%%
...
%\begin{itemize}
	...
	%%
	However, we still display the whole 3D object instead of cutting away information. %down to the slice position.
	%%
...
\begin{figure}[htb]
 ...
 \caption{
 The front-end (left) is realized with \texttt{HTML5}/\texttt{CSS3}/\texttt{Javascript} and different Javascript libraries, such as \href{https://www.angularjs.org/}{\texttt{Angular.js}}, \href{http://threejs.org}{\texttt{Three.js}} and \href{http://d3js.org/}{\texttt{D3.js}}.
 %%
...
The 3D plot is created using the WebGL-based \href{http://threejs.org}{\texttt{Three.js}} library.
%%
...
%%
Sylvia Gla{\ss}er and Kai Lawonn are funded by the Federal Ministry of Education and Research within the Forschungscampus STIMULATE under grant number '13GW0095A'.
}
\end{small}
\clearpage
\newpage

...
%%
The source for the prototype is freely available at \texttt{Github}.
%%
Instructions and code on how to create a setup running the \emph{Regression Cube} statistical backend through a \texttt{Ubuntu} server using \texttt{OpenCPU} can be found here: \href{https://github.com/paulklemm/regression-cube-r-package}{\texttt{github.com/paulklemm/regression-cube-r-package}}.
%%
The front-end source as well as the \texttt{Nodejs} backend can be found here: \href{https://github.com/paulklemm/regression-cube-prototype}{\texttt{github.com/paulklemm/regression-cube-prototype}}.
%%
Using \href{https://www.heroku.com/}{\texttt{www.heroku.com}}, the front-end setup is as easy as cloning the repository into a Heroku homepage. 
%%
